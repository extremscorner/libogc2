...
#define WPAD_CLASSIC_BUTTON_FULL_R				(0x0002u<<16)
#define WPAD_CLASSIC_BUTTON_PLUS				(0x0004u<<16)
#define WPAD_CLASSIC_BUTTON_HOME				(0x0008u<<16)
#define WPAD_CLASSIC_BUTTON_MINUS				(0x0010u<<16)
#define WPAD_CLASSIC_BUTTON_FULL_L				(0x0020u<<16)
#define WPAD_CLASSIC_BUTTON_DOWN				(0x0040u<<16)
#define WPAD_CLASSIC_BUTTON_RIGHT				(0x0080u<<16)
#define WPAD_CLASSIC_BUTTON_UP					(0x0100u<<16)
#define WPAD_CLASSIC_BUTTON_LEFT				(0x0200u<<16)
#define WPAD_CLASSIC_BUTTON_ZR					(0x0400u<<16)
#define WPAD_CLASSIC_BUTTON_X					(0x0800u<<16)
#define WPAD_CLASSIC_BUTTON_A					(0x1000u<<16)
#define WPAD_CLASSIC_BUTTON_Y					(0x2000u<<16)
#define WPAD_CLASSIC_BUTTON_B					(0x4000u<<16)
#define WPAD_CLASSIC_BUTTON_ZL					(0x8000u<<16)

#define WPAD_GUITAR_HERO_3_BUTTON_PLUS			(0x0004u<<16)
#define WPAD_GUITAR_HERO_3_BUTTON_MINUS			(0x0010u<<16)
#define WPAD_GUITAR_HERO_3_BUTTON_STRUM_DOWN	(0x0040u<<16)
#define WPAD_GUITAR_HERO_3_BUTTON_STRUM_UP		(0x0100u<<16)
#define WPAD_GUITAR_HERO_3_BUTTON_YELLOW		(0x0800u<<16)
#define WPAD_GUITAR_HERO_3_BUTTON_GREEN			(0x1000u<<16)
#define WPAD_GUITAR_HERO_3_BUTTON_BLUE			(0x2000u<<16)
#define WPAD_GUITAR_HERO_3_BUTTON_RED			(0x4000u<<16)
#define WPAD_GUITAR_HERO_3_BUTTON_ORANGE		(0x8000u<<16)
