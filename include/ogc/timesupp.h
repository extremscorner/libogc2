#ifndef __OGC_TIMESUPP_H__
#define __OGC_TIMESUPP_H__
...
#define TB_SECSPERHR				(TB_SECSPERMIN*TB_MINSPERHR)
#define TB_SECSPERDAY				(TB_SECSPERHR*TB_HRSPERDAY)
#define TB_SECSPERYR				(TB_SECSPERDAY*TB_DAYSPERYR)
...
#define tick_microsecs(ticks)		((((u64)(ticks)%(TB_TIMER_CLOCK*1000))*8)/(TB_TIMER_CLOCK/125))
#define tick_nanosecs(ticks)		((((u64)(ticks)%(TB_TIMER_CLOCK*1000))*8000)/(TB_TIMER_CLOCK/125))
